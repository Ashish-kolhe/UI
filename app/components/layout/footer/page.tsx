...
export const metadata: Metadata = {
  ...
  description: "A footer component for website footers",
}
  ...
  return (
    <div className="container py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-500">A footer component for website footers.</p>
      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                      ...
                      <ul className="mt-4 space-y-4">
                        ...
                        <li>
                          <a href="#" className="text-base text-gray-500 hover:text-gray-900">Community</a>
                        </li>
                        <li>
                          <a href="#" className="text-base text-gray-500 hover:text-gray-900">Webinars</a>
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="mt-4 space-y-4">
                        ...
                        <li>
                          <a href="#" className="text-base text-gray-500 hover:text-gray-900">Licenses</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 text-center">&copy; 2025 Company Name, Inc. All rights reserved.</p>
                  </div>
                </div>
              </footer>
            `}
  ...
  return (
    <footer className="bg-white border-t border-gray-200 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4">Footer with Newsletter</h2>
          <ComponentPreview
                      ...
                      <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div className="mt-12 md:mt-0">
                          ...
                          <form className="mt-4 sm:flex sm:max-w-md">
                            ...
                            <input type="email" name="email-address" id="email-address" autoComplete="email" required className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary focus:placeholder-gray-400" placeholder="Enter your email" />
                            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                              <button type="submit" className="w-full bg-primary border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                Subscribe
                              </button>
                            </div>
                          </form>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <div className="prose max-w-none">
            <p>
              To use the Footer component in your project, you can copy the code from the examples above. The Footer
            ...
            <ul>
              ...
              <li>Multiple layout options (simple, multi-column, with newsletter)</li>
              <li>Customizable colors and styling</li>
              <li>Social media links and navigation menus</li>
            </ul>
            <h3>Customization</h3>
            <p>
              You can customize the Footer component by modifying the Tailwind CSS classes. For example, to change the
